  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var w2 = function() {
      ...
      return s(t2, [{ key: "roundPathCorners", value: function(t3, e2) {
        ...
        if (z2.attr("index", a2), x2 && z2.attr({ "clip-path": "url(#gridRectMask".concat(A3.globals.cuid, ")") }), "none" !== A3.config.states.normal.filter.type) S2.getDefaultFilter(z2, a2);
    ...
    var A2 = function() {
      ...
      return s(t2, [{ key: "setOrientations", value: function(t3) {
        ...
        if (this.annoCtx.invertAxis) {
          ...
          if (r2.config.yaxis[e2.yAxisIndex].logarithmic) h3 = (a2 = new k(this.annoCtx.ctx).getLogVal(r2.config.yaxis[e2.yAxisIndex].logBase, a2, c2)) / r2.globals.yLogRatio[c2];
          else h3 = (a2 - r2.globals.minYArr[c2]) / (r2.globals.yRange[c2] / r2.globals.gridHeight);
      ...
      return s(t2, [{ key: "drawGridArea", value: function() {
        ...
        if (void 0 !== i2.config.grid.column.colors && i2.config.grid.column.colors.length > 0) {
          ...
          for (var h3 = i2.globals.padHorizontal, c2 = i2.globals.padHorizontal + i2.globals.gridWidth / l2, d2 = i2.globals.gridHeight, g2 = 0, u2 = 0; g2 < t3; g2++, u2++) {
            var p2;
            if (u2 >= i2.config.grid.column.colors.length && (u2 = 0), "datetime" === i2.config.xaxis.type) h3 = this.xaxisLabels[g2].position, c2 = ((null === (p2 = this.xaxisLabels[g2 + 1]) || void 0 === p2 ? void 0 : p2.position) || i2.globals.gridWidth) - this.xaxisLabels[g2].position;
        ...
        switch (m3) {
          ...
          case "smooth":
            ...
            if (null === i2[a2][s2]) u2 = 0;
              ...
              case 1:
                if (null === i2[a2][s2 + 1]) f2 += L2 ? A3.line(d2, h3) : A3.move(d2, g2), x2 += A3.line(d2, S2) + A3.line(p2, S2) + "z", b2.push(f2), v2.push(x2), u2 = -1;
                else {
    ...
    var Vt = function() {
      ...
      return s(t2, [{ key: "setupElements", value: function() {
        ...
        if (s2.comboCharts) {
          ...
          if (o2.series.length > 0) (S2 = A3).push.apply(S2, p(L2.drawSeriesByGroup(o2, s2.areaGroups, "area", v2)));
          ...
          if (u2.series.length > 0 && A3.push(v2.draw(u2.series, "rangeArea", u2.i, u2.seriesRangeEnd)), r2.series.length > 0) (C2 = A3).push.apply(C2, p(L2.drawSeriesByGroup(r2, s2.lineGroups, "line", v2)));
          ...
          case "area":
            ...
            break;
          case "bar":
            if (a2.chart.stacked) A3 = new At(this.ctx, e2).draw(s2.series);
