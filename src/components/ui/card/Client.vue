<template>
  <div
    class="card border border-gray-50 py-4 px-5 shadow-sm bg-white flex items-center relative"
  >
    <div class="status bg-violet-300 h-full w-[40px] flex flex-col">
      <p class="rotate-[-90deg]">Новый</p>
    </div>
